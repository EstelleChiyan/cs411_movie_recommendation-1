...
class HeaderComonent extends Component {
    ...
    clickReview() {
        ...
        //if (UsernameLoggedIn !== ''){
            this.setState({username:userlogin,loginstatus:true,reviewpath: path});
            //console.log('here');
        }
        else{
            this.setState({username:'',loginstatus:false,reviewpath: '/reviews'});
        }
    ...
    render(){
        ...
        return(
            ...
            <header>
                ...
                <div><a href="http://www.idkmovie.com" className="navbar-brand">MovieStudio</a></div>
                    <ul className="navbar-nav">
                        <li><Link className="nav-link" to="/login">Category</Link></li>
                        <li><Link className="nav-link" to="/logout">Trend</Link></li>
                        <li><Link className="nav-link" to="/recommend">Recommend</Link></li>
                    </ul>
                    ...
                    <ul className="navbar-nav navbar-collapse justify-content-end">
                        ...
                        <li><Link className="nav-link" to={this.state.reviewpath} onClick={this.clickReview}>Review</Link></li>
                        {!isUserLoggedIn && <li><Link className="nav-link" to="/login">Login</Link></li>}
                        {isUserLoggedIn && <li><Link className="nav-link" to="/logout" onClick={this.clickLogout}>Logout</Link></li>}
                    </ul>
                </nav>
            </header>
        )
