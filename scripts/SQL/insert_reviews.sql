...
Rating: B-", "2019-01-13", 299537, 2),
("5c83158b925141291919251d", "Captain Marvel is a hot mess narratively and never really knows what kind of movie it wants to be. Brie Larson is constantly fighting direction and poor writing and losing the battle in the end. The last thing the MCU needs right now is a Mary Sue with no life. The one thing this movie misses more than anything else though is heart. Without a reason or purpose for existing one is left asking…other than explaining pointless MCU plot points and creating a plethora of fresh plot holes…why was this movie made and who was it made for? Kudos must be given to the make-up artists and a lot of the tech guys behind the scenes. C-", "2018-11-15", 299537, 3),
("5c83eadf0e0a2642fe6302be", "I wasn't going to see this movie at all based on the stupid comments made by Brie Larson but I tagged along with some friends anyway. Let me just say it was a massive mistake. I underestimated how difficult it would be to stand looking at the lead actress misogynistic and talentless face for two hours. On top of the train wreck that was her 'performance' the whole story just felt flat and bland, I don't want to spoil the plot for those who have already bought tickets and are going to see it anyway, but let's just say that it was almost as underwhelming in story as it was in acting. DO NOT RECOMMEND!



1/10", "2019-03-20", 299537, 4),
("5c842502c3a3684e98da8aa3", "Captain Marvel bored the living hell out of me. I'm tired of these special effects laden \"event films\" where every scene has to be flashy lights and fighting and explosions where nothing of real value is at stake. Not one character in this film has a personality or character arc. It's one big extended buildup to showcase how badly Captain Marvel is going to kick Thanos' ass. I like the character but I did not like what this movie does with her character. I was also shocked at how bad Brie Larson's performance was; she's an incredible actress but I feel Jennifer Lawrence put more effort into her Mystique than Larson did with Carol Danvers.



Also if your idea of female empowerment is a nasty leather jacket biker guy whistling at a girl saying \"give me a kiss\" and then the girl just goes and steals his bike, you have no clue what real female empowerment is.", "2018-06-29", 299537, 5),
("5c8676f1c3a36813c2d325cb", "okay i wanted to see this despite the 'contravercy sexist pig like men have turned this into'so i went to my local theater picked a showtime and picked out some snacks the movie was decent not good not bad just the right amount of each to make it watchable for folks the action had a nice pace and the humor was just right and i think captain marvel herself is a beautiful badass and i adored the cat he was so cute and fluffy i say go see it dont over expect but go see it", "2018-11-28", 299537, 6),
("5c9d166cc3a368180e271bcd", "I never watched a movie 2 time but captain marvel is one and only movie that i watched 2 time in my life.Amazing movie.", "2018-07-06", 299537, 7),
("5ca979219251415662ff1b66", "It has good visuals, good action, and some decent humour. This movie does what it needs to do by introducing Captain Marvel, although I was hoping Marvel would do something different and unique from their other origin story.", "2018-04-30", 299537, 8),
("5cacc2be0e0a2679dea25f82", "Look, as an actor, it is your duty to make sure that you promote your brand to the best of your ability, it's JUST as important as the work that you do shooting the film. I don't care about the political side of the events that transpired before the release of this movie, but I hope that Hollywood learns the lesson taught by Brie Larson.", "2018-02-22", 299537, 9),
("5c59b0a0c3a36830288a2e0b", "i got the pleasure of getting a sneak peek of this movie its pretty great i laughed out loud and really had feelings for the characters in this movie its a good choice for older kids i dont think however its a good idea for younger kids its more dark the villans more frightening then before the movie is good very good though", "2018-11-17", 166428, 0),
("5c9a120d0e0a264cd3c53d47", "The best dream-works movie yet for kids and <a hre=\"http://quizlets.co/\">quizlet</a> teens !!! It has a great story, great animation and great characters here's my review: The story: 10/10 the animation: 10/10 and the characters: 10/10 the movie: 10/10!!!", "2018-07-22", 166428, 1),
("5c855c6bc3a3684e8fdd63ff", "Jordan peele is one of the best dictators in the world with only two movies and this movie is amazing 

96%", "2018-05-10", 458723, 0),
("5c926f1bc3a3686111535623", "If you enjoy reading my Spoiler-Free reviews, please follow my blog :\)
...
Advice: focus on the boy’s actions, and how he reacts to everything he sees or does.", "2018-08-21", 458723, 1),
("5c9aa1dac3a36872983d2206", "Led by stellar performances and careful directing, Us asks more questions than it answers, giving the audience all the tools needed to solve every single mystery for themselves, making this an uncommonly effective horror masterpiece.", "2018-09-18", 458723, 2),
("5cb0843dc3a3683c26ac18e0", "_Us_ is gonna be a tough one to review. Difficult to review without spoilers, which is what I'm gonna do here, but I think even if I was doing spoilers, I'd still struggle.
...
_Final rating:★★★ - I liked it. Would personally recommend you give it a go._", "2019-01-19", 458723, 3),
("5cafeec40e0a2626cac3aca2", "Decent, by the numbers, popcorn movie. Better than the other live action Transformers movie, but still not very good. Best parts were the fight scenes, especially on Cybertron. Otherwise, it was average, 5/10.", "2018-04-02", 424783, 0),
("5adff809c3a3683daa00ad3d", "\"It is a bold undertaking, to readjust what is expected of the MCU/Avengers formula, and there are moments when the sheer scale and momentum match the narrative ambition...\"



Read the full review here: http://screen-space.squarespace.com/reviews/2018/4/25/avengers-infinity-war.html", "2018-05-22", 299536, 0),
("5ae02e1e0e0a26156900f6da", "Amazing.  Visually stunning.  So much going on, but somehow also clear and easy to understand.  A little flabby in the middle third, but given the huge cast and story to cover it is very understandable.  The highlight was the parings of characters from different stories and their interactions.
...
10/10", "2018-04-30", 299536, 1),
("5ae0a3d20e0a26156301455e", "Just a very short, NO SPOILERS review I wanted to get down while it's still fresh.
...
_Final rating:★★★★ - Very strong appeal. A personal favourite._", "2018-03-14", 299536, 2),
("5ae4205b0e0a266c71003206", "The third act turns on a character being an idiot. That story beat renders all that the heroes do before and after it immaterial. That moment so preoccupied me that I couldn't enjoy the rest of the story, and made it impossible to ignore the flick's other glaring flaws anymore: the villain's motive makes no sense, the glove exists only to produce plot contrivances, the score is so obvious it might as well be cue cards on screen \(\"Feel sad now\"\) ...



The first half is some of the best action in a Disney Marvel entry yet, and the other half is so stupid that it sours the whole MCU experience.", "2019-02-15", 299536, 3),
("5ae77ce60e0a262b9700a2df", "Best MCU movie, more than that.... BEST SUPERHERO MOVIE EVER. Hands Down", "2018-05-06", 299536, 4),
("5ae85089c3a368134801a38e", "Nice Movie.", "2018-11-01", 299536, 5),
("5ae866939251410cdc016c31", "Massive, epic movie. I'm so happy that Marvel is stepping up their game with their villains. For too long, MCU villains have been too bland and generic. But lately, the villains have improved with Michael Keaton's Vulture, Michael B. Jordan's Killmonger, and now James Brolin's Thanos. Thanos has appeared in several other MCU films, but he seemed rather flat in those movies. Here, he's allowed to be fully developed as a character. Especially touching is his relationship with his adoptive daughter, Gamora. It's actually surprisingly tender and moving. Thanos is the actual main focus of the film, and if he failed as a character, the entire movie wouldn't have worked. So bravo, Marvel!", "2019-01-10", 299536, 6),
("5b043a7a0e0a2623ec029554", "Best Movie Ever...", "2018-08-14", 299536, 7),
("5b3a6dfcc3a36845b800feee", "Moving ending, but easily the least of the Avengers movies
...
GRADE: C+", "2018-11-28", 299536, 8),
("5b72ec050e0a267ef11b5f8c", "I Love this movie.", "2018-02-19", 299536, 9),
("5b97fa459251413c68000753", "It's the epitome of superhero trash and the franchise of manchildren.  The ultimate smashing your toys together to battle only this time it's for the world to see.", "2018-12-27", 299536, 10),
("5c8425420e0a26430a636548", "In 2012, Marvel Studios changed the cinematic landscape with a payoff that was five films in the making, proving a linked universe of movies could work.
...
We all know the film isn't the Endgame, but we're primed and ready for Part 2. Shut up and take my  Marvel!", "2018-10-11", 299536, 11),
("5c22507dc3a368700bee2ef5", "Good movie to watch.", "2018-09-22", 297802, 0),
("5c28f1c192514138d7c0a503", "***Lame-axx butt of a joke no longer*** 
...
GRADE: B", "2018-06-22", 297802, 1),
("5c2e36e192514164516c81ba", "I just came back home from watching Aquaman on the IMAX theater in Balexert in Geneva and thought that I should write something up while it’s still fresh in my mind. Something that happens all too rarely.
...
The one gripe I have about the movie is the totally unnecessary green preaching crap. Luckily it is confined to a couple of scenes but in those it is really slapped in the audience’s faces. A superhero movie should be entertaining, not preaching. If I want that shit I can turn on the news. It’s a star off from me just for that nonsense.", "2018-07-14", 297802, 2),
("5c43f2630e0a266d5ad25734", "Doesn't hold a candle to _Wonder Woman_, but tall-buildings worth of leaps \(and bounds\) better than everything else that's come out of the DCIThoughtSheWasWithU. It's weirdly kind of... The nicest? Of these movies? Which is not the kind of direction you would think a film in this series would go based on how it started, but Jason Momoa is just charismatic as **Hell**, and _Aquaman_ leans on that a lot.
